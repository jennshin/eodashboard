module.exports = [
  {
    ...
    introText: '/eodash-data/general/intro',
    mapsText: '/eodash-data/general/maps',
    proxiesText: '/eodash-data/general/proxies',
    sourcesText: '/eodash-data/general/sources',
  ...
  },
  {
    ...
    introText: '/data/trilateral/intro',
    mapsText: '/data/trilateral/maps',
    proxiesText: '/data/trilateral/proxies',
    sourcesText: '/data/trilateral/sources',
