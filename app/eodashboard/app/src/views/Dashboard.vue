  ...
  <div class="dashboard fill-height">
    ...
    >
      ...
      <template v-else>
        ...
        <Intro v-else-if="showText === 'intro'" />
        <Proxies v-if="showText === 'proxies'" />
        <Maps v-else-if="showText === 'maps'" />
        <Sources v-else-if="showText === 'sources'" />
      </template>
    </v-navigation-drawer>
    <v-dialog
    ...
    >
      ...
      >
        ...
        <template v-else>
          ...
          <Intro v-else-if="showText === 'intro'" style="padding-bottom: 100px !important" />
          <Maps v-else-if="showText === 'maps'" style="padding-bottom: 100px !important" />
          <Proxies v-else-if="showText === 'proxies'" style="padding-bottom: 100px !important" />
          <Sources v-else-if="showText === 'sources'" style="padding-bottom: 100px !important" />
        </template>
      </div>
    </v-dialog>
